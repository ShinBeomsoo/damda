...
final class LocalizationManager {
    ...
    private let enFallback: [String: String] = {
        let pairs: [(String, String)] = [
            ...
            // Settings
            ("설정", "Settings"),
            ("앱의 모든 설정을 관리합니다", "Manage all app settings"),
            ("일반", "General"),
            ("앱 언어를 선택하세요", "Select app language"),
            ("테마를 선택하세요", "Select theme"),
            ("알림", "Notifications"),
            ("복습 알림을 설정하세요", "Configure review notifications"),
            ("학습 관리", "Study Management"),
            ("자동으로 하루를 마감합니다", "Automatically end the day"),
            ("지금 하루를 마감합니다", "End the day now"),
            ("마감", "End"),
            ("목표", "Goals"),
            ("학습 시간 목표", "Study Time Goals"),
            ("하루 학습 시간 목표를 설정하세요", "Set daily study time goals"),
            ("닫기", "Close"),
            // Notification settings
            ("알림 설정", "Notification Settings"),
            ("알림 활성화됨", "Notifications Enabled"),
            ("알림 비활성화됨", "Notifications Disabled"),
            ("알림 권한 요청", "Request Permission"),
            ("기본 알림 시간", "Default Notification Time"),
            ("점심과 저녁에 복습 알림이 발송됩니다", "Review notifications are sent at lunch and dinner time"),
            ("사용자 정의 알림 시간", "Custom Notification Time"),
            ("추가 알림 설정", "Add Notification"),
            ("알림 목록", "Notification List"),
            ("설정된 알림이 없습니다.", "No notifications scheduled"),
            ("알림 설정 완료", "Notification Setup Complete"),
            ("확인", "OK"),
            ("사용자 정의 알림이 설정되었습니다.", "Custom notification has been set"),
            ("추가", "Add"),
